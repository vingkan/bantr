 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(x,T){var O=x.length;x.push(T);e:for(;0<O;){var U=O-1>>>1,re=x[U];if(0<i(re,T))x[U]=T,x[O]=re,O=U;else break e}}function n(x){return x.length===0?null:x[0]}function r(x){if(x.length===0)return null;var T=x[0],O=x.pop();if(O!==T){x[0]=O;e:for(var U=0,re=x.length,It=re>>>1;U<It;){var kt=2*(U+1)-1,ar=x[kt],An=kt+1,As=x[An];if(0>i(ar,O))An<re&&0>i(As,ar)?(x[U]=As,x[An]=O,U=An):(x[U]=ar,x[kt]=O,U=kt);else if(An<re&&0>i(As,O))x[U]=As,x[An]=O,U=An;else break e}}return T}function i(x,T){var O=x.sortIndex-T.sortIndex;return O!==0?O:x.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var a=[],u=[],d=1,c=null,h=3,g=!1,_=!1,v=!1,k=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate!="undefined"?setImmediate:null;typeof navigator!="undefined"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(x){for(var T=n(u);T!==null;){if(T.callback===null)r(u);else if(T.startTime<=x)r(u),T.sortIndex=T.expirationTime,e(a,T);else break;T=n(u)}}function w(x){if(v=!1,m(x),!_)if(n(a)!==null)_=!0,oi(I);else{var T=n(u);T!==null&&li(w,T.startTime-x)}}function I(x,T){_=!1,v&&(v=!1,p(A),A=-1),g=!0;var O=h;try{for(m(T),c=n(a);c!==null&&(!(c.expirationTime>T)||x&&!$e());){var U=c.callback;if(typeof U=="function"){c.callback=null,h=c.priorityLevel;var re=U(c.expirationTime<=T);T=t.unstable_now(),typeof re=="function"?c.callback=re:c===n(a)&&r(a),m(T)}else r(a);c=n(a)}if(c!==null)var It=!0;else{var kt=n(u);kt!==null&&li(w,kt.startTime-T),It=!1}return It}finally{c=null,h=O,g=!1}}var R=!1,N=null,A=-1,j=5,L=-1;function $e(){return!(t.unstable_now()-L<j)}function Pn(){if(N!==null){var x=t.unstable_now();L=x;var T=!0;try{T=N(!0,x)}finally{T?On():(R=!1,N=null)}}else R=!1}var On;if(typeof f=="function")On=function(){f(Pn)};else if(typeof MessageChannel!="undefined"){var si=new MessageChannel,Os=si.port2;si.port1.onmessage=Pn,On=function(){Os.postMessage(null)}}else On=function(){k(Pn,0)};function oi(x){N=x,R||(R=!0,On())}function li(x,T){A=k(function(){x(t.unstable_now())},T)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(x){x.callback=null},t.unstable_continueExecution=function(){_||g||(_=!0,oi(I))},t.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<x?Math.floor(1e3/x):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(a)},t.unstable_next=function(x){switch(h){case 1:case 2:case 3:var T=3;break;default:T=h}var O=h;h=T;try{return x()}finally{h=O}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(x,T){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var O=h;h=x;try{return T()}finally{h=O}},t.unstable_scheduleCallback=function(x,T,O){var U=t.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?U+O:U):O=U,x){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=O+re,x={id:d++,callback:T,priorityLevel:x,startTime:O,expirationTime:re,sortIndex:-1},O>U?(x.sortIndex=O,e(u,x),n(a)===null&&x===n(u)&&(v?(p(A),A=-1):v=!0,li(w,O-U))):(x.sortIndex=re,e(a,x),_||g||(_=!0,oi(I))),x},t.unstable_shouldYield=$e,t.unstable_wrapCallback=function(x){var T=h;return function(){var O=h;h=T;try{return x.apply(this,arguments)}finally{h=O}}}})(Wp);$p.exports=Wp;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jo{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=ut.ACK_USER_WRITE,this.source=z_()}operationForChild(e){if(z(this.path)){if(this.affectedTree.value!=null)return S(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new G(e));return new Jo(W(),n,this.revert)}}else return S(b(this.path)===e,"operationForChild called for unrelated child."),new Jo(K(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class us{constructor(e,n,r){this.source=e,this.path=n,this.children=r,this.type=ut.MERGE}operationForChild(e){if(z(this.path)){const n=this.children.subtree(new G(e));return n.isEmpty()?null:n.value?new er(this.source,W(),n.value):new us(this.source,W(),n)}else return S(b(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new us(this.source,K(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
